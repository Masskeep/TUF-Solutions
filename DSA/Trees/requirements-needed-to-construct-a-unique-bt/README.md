# [Requirements needed to construct a unique BT](https://takeuforward.org/plus/dsa/problems/requirements-needed-to-construct-a-unique-bt?source=strivers-a2z-dsa-track&tab=submissions)
