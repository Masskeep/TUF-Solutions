# [Print root to leaf path in BT](https://takeuforward.org/plus/dsa/problems/print-root-to-note-path-in-bt?source=strivers-a2z-dsa-track&tab=submissions)
...
**Input:** root = [1, 2, 3, 4, null, 5, 6, null, 7]</p><img src="https://static.takeuforward.org/content/ProblemSetter-JU7Hm_WW">
